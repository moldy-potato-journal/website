        ...
        <Card className="rounded-none border-border bg-background shadow-none">
          <CardHeader className="gap-4">
            ...
            <CardDescription className="max-w-3xl text-base leading-8">
              It may not have been published yet, its number may be incorrect,
              or the record may have been moved in the content archive.
            </CardDescription>
          </CardHeader>
        ...
        <Card className="rounded-none border-border bg-background shadow-none">
          <CardHeader>
            ...
            <CardTitle className="font-heading text-3xl leading-tight sm:text-4xl">
              Suggested reading from the current archive.
            </CardTitle>
            <CardDescription className="max-w-3xl text-base leading-8">
              While this record is unavailable, these published articles are a
