    ...
    <Card className="rounded-none border-border bg-background shadow-none">
      ...
      <CardContent className="space-y-4">
        <div>
          ...
          <p className="mt-1 text-sm font-mono">{article.articleNumber}</p>
        </div>
        <Separator />
        <div>
        ...
        <div>
          ...
          <p className="mt-1 text-sm uppercase">{article.contentType}</p>
        </div>
        <Separator />
        <div>
          <p className="font-mono text-xs text-muted-foreground">Authors</p>
        ...
        {article.publishDate ? (
          <>
            ...
            <div>
              ...
              <p className="mt-1 text-sm">{article.publishDate}</p>
            </div>
          </>
        ) : null}
        {article.tags.length > 0 ? (
          <>
            ...
            <div>
              ...
              <p className="mt-1 text-sm">{article.tags.join(", ")}</p>
            </div>
          </>
        ) : null}
      </CardContent>
