...
export default async function ArticlePage({ params }: ArticlePageProps) {
  ...
  const { article, siteTitle } = articlePageData
          ...
          <Card className="rounded-none border-border bg-background shadow-none">
            <CardHeader>
              ...
              <p className="max-w-3xl text-sm leading-7 text-muted-foreground">
                This is not a certified academic article. Readers should judge
                its claims, methods, and sincerity for themselves.
              </p>
            </CardHeader>
          </Card>
        </section>
            ...
            <Card className="rounded-none border-border bg-background shadow-none">
              <CardHeader>
                ...
                <CardDescription className="text-sm leading-7">
                  Reading, archive navigation, and discussion access for this
                  article.
                </CardDescription>
              </CardHeader>
              <CardFooter className="flex flex-wrap gap-3">
                ...
                <Button asChild>
                  <a href={article.rawContentUrl} download>
                    Download Article
                  </a>
                </Button>
